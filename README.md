...
**Tools & Platforms:** Excel (Advanced) | Power BI | AWS (learning) | Linux | LIMS | Git  
**Core Competencies:** Data preprocessing & validation | Model evaluation & interpretation | Workflow documentation | Data integrity QA | Statistical analysis
...
**Lead Author — AI-driven Lung Cancer Screening Study**  
Manuscript under review at *BMC Medical Imaging* (2025). Developed explainable multiclass classification model for Lung-RADS CT assessment using ensemble methods and visual interpretation techniques.

**Co-Author — NLP Benchmark Dataset for Automotive Text Analysis**  
Contributed to dataset curation and preprocessing for *LREC 2025 submission*. Created multi-domain corpus for sentiment analysis and classification benchmarking.

**PMI Project Management Ready Certified (2025)**  
Completed formal training in project lifecycle management, stakeholder communication, and risk assessment.
...
Co-author on NLP benchmark dataset paper submitted to *LREC 2025 Conference*.

**Hackathon Presentation**  
"Interpretable Text Classification for Automotive Listings" — AutoTrader UK Data Science Hackathon (Winner, 2025).
...
**GitHub:** [Your repositories and project code]
